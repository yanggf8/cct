...
@MODELS.register_module('time-series-forecasting', module_name='my-custom-model')
class TFTNHITSModel(TorchModel):
...
@PREPROCESSORS.register_module('time-series-forecasting', module_name='my-custom-preprocessor')
...
@PIPELINES.register_module('time-series-forecasting', module_name='my-custom-pipeline')
...
if __name__ == "__main__":
    ...
    input = "Hello, ModelScope!"
    inference = pipeline('time-series-forecasting', model=usr_config_path)
