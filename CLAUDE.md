...
- **Current Version**: Latest (2026-01-29 - Security & Cache Fixes v3.10.14)
...
|---------|--------|--------|
| **Security & Cache Fixes v3.10.14** | ✅ Complete | XSS prevention (HTML/JS escaping for runId, errors, U+2028/U+2029 line separators), EOD cache validation (only accepts pre-market shaped data), stages endpoint auth fix (truly public GET) |
