...
|---------|--------|--------|
| **Security & Cache Fixes v3.10.14** | ✅ Complete | XSS prevention (HTML/JS escaping for runId, errors), EOD cache validation (only accepts pre-market shaped data), stages endpoint auth fix (truly public GET) |
