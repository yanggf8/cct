...
export class SymbolValidator {
  static readonly SYMBOL_PATTERN = /^[A-Z]{1,5}$/;
...
export class DateValidator {
  ...
  static readonly MAX_DATE = new Date().toISOString().split('T')[0];
 ...
 */
export function validateInput(input: any, type: string, options?: any): ValidationResult {
  try {
    switch (type) {
      case 'symbol':
