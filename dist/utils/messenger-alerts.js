 ...
 */
export async function sendFacebookMessengerAlert(alerts, analysisResults, env) {
 ...
 * @param env - Cloudflare environment variables
 */
export async function sendFacebookSignalCard(alert, signal, env) {
    try {
 ...
 * @param env - Cloudflare environment variables
 */
export async function sendLINEAlert(alerts, analysisResults, env) {
 ...
 */
export function createLINEFlexMessage(alerts, analysisResults) {
    const perf = analysisResults.performance_metrics;
 ...
 */
export async function sendLINESticker(userId, token) {
    try {
 ...
 */
export function getCompanyDomain(symbol) {
    const domainMap = {
        'AAPL': 'apple.com',
        'TSLA': 'tesla.com',
        'MSFT': 'microsoft.com',
 ...
 * @param env - Cloudflare environment variables
 */
export async function sendCriticalMessengerAlert(errorMessage, env) {
...
//# sourceMappingURL=messenger-alerts.js.map