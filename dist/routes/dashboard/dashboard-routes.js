 ...
 */
function generateSampleDashboardMetrics() {
 ...
 */
function generateSampleCostToServeMetrics() {
    const now = new Date().toISOString();
    return {
        storage_costs: {
 ...
 */
function generateSampleGuardViolationData() {
    const now = new Date().toISOString();
    return {
        violations: [
            {
 ...
 */
export async function getDashboardMetrics(request, env, ctx, headers) {
    try {
        ...
        const body = ApiResponseFactory.error('Failed to fetch dashboard metrics', 'DASHBOARD_METRICS_ERROR', {
            requestId: headers['X-Request-ID'],
 ...
 */
export async function getCostToServeMetrics(request, env, ctx, headers) {
    try {
        ...
        const body = ApiResponseFactory.error('Failed to fetch cost-to-serve metrics', 'ECONOMICS_METRICS_ERROR', {
            requestId: headers['X-Request-ID'],
            message: error.message
        });
        return new Response(JSON.stringify(body), {
 ...
 */
export async function getGuardViolationData(request, env, ctx, headers) {
    try {
        ...
        const severity = queryParams.severity; // low, medium, high, critical
        ...
        const body = ApiResponseFactory.error('Failed to fetch guard violation data', 'GUARD_VIOLATION_ERROR', {
            requestId: headers['X-Request-ID'],
            message: error.message
        });
        return new Response(JSON.stringify(body), {
 ...
 */
export async function getDashboardHealth(request, env, ctx, headers) {
    try {
        ...
        const body = ApiResponseFactory.error('Failed to check dashboard health', 'DASHBOARD_HEALTH_ERROR', {
            requestId: headers['X-Request-ID'],
            message: error.message
        });
        return new Response(JSON.stringify(body), {
 ...
 */
export async function refreshDashboardData(request, env, ctx, headers) {
    try {
        ...
        const body = ApiResponseFactory.error('Failed to refresh dashboard data', 'DASHBOARD_REFRESH_ERROR', {
            requestId: headers['X-Request-ID'],
            message: error.message
        });
        return new Response(JSON.stringify(body), {
