...
import { validateApiKey, generateRequestId, parseQueryParams } from './api-v1.js';
import { generatePredictiveSignals, analyzeMarketPatterns, generatePredictiveInsights } from '../modules/predictive-analytics.js';
import { createLogger } from '../modules/logging.js';
const logger = createLogger('predictive-analytics-routes');
/**
 * Handle predictive analytics routes
 */
export async function handlePredictiveAnalyticsRoutes(request, env, path, headers) {
    ...
    try {
        ...
        logger.error('PredictiveAnalyticsRoutes Error', { error: error.message, requestId, path, method });
...
async function handlePredictiveSignals(request, env, headers, requestId) {
    ...
    try {
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(filteredSignals, {
            source: 'fresh',
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate predictive signals', 'SIGNALS_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handlePatternAnalysis(request, env, headers, requestId) {
    ...
    try {
        ...
        const patternCount = filteredPatterns.market_patterns.seasonal_tendencies.length +
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(filteredPatterns, {
            source: 'fresh',
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to analyze market patterns', 'PATTERNS_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handlePredictiveInsights(request, env, headers, requestId) {
    ...
    try {
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(filteredInsights, {
            source: 'fresh',
            ttl: 2400, // 40 minutes
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate predictive insights', 'INSIGHTS_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleMarketForecast(request, env, headers, requestId) {
    ...
    try {
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(forecast, {
            source: 'fresh',
            ttl: 1800, // 30 minutes
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate market forecast', 'FORECAST_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handlePredictiveAnalyticsHealth(request, env, headers, requestId) {
    ...
    try {
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to perform predictive analytics health check', 'HEALTH_CHECK_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handlePredictiveGenerate(request, env, headers, requestId) {
    ...
    try {
        ...
        const { timeframe = '1w', indicators = ['technical', 'fundamental', 'sentiment', 'volatility'], confidence = 70 } = body;
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(prediction, {
            source: 'fresh',
            ttl: 1800,
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate prediction', 'GENERATION_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleEnsemblePrediction(request, env, headers, requestId) {
    ...
    try {
        ...
        const body = await request.json();
        const { models = ['gpt_oss_120b', 'distilbert'], predictionType = 'sector_rotation', timeframe = '1w', consensus = true } = body;
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(ensemble, {
            source: 'fresh',
            ttl: 1800,
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate ensemble prediction', 'ENSEMBLE_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleSymbolPrediction(request, env, headers, requestId) {
    ...
    try {
        ...
        const body = await request.json();
        const { symbol, predictionType = 'price_direction', timeframe = '3d', includeIndicators = ['technical', 'sentiment', 'volume'] } = body;
        if (!symbol) {
            return new Response(JSON.stringify(ApiResponseFactory.error('Symbol is required', 'INVALID_REQUEST', { requestId })), {
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate symbol-specific prediction', 'SYMBOL_PREDICTION_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleAccuracyAnalysis(request, env, headers, requestId) {
    ...
    try {
        ...
        const body = await request.json();
        const { timeframe = '1w', lookbackPeriod = 90, models = ['gpt_oss_120b', 'distilbert'] } = body;
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(accuracy, {
            source: 'fresh',
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to analyze prediction accuracy', 'ACCURACY_ANALYSIS_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleRegimePrediction(request, env, headers, requestId) {
    ...
    try {
        ...
        const body = await request.json();
        const { features = ['volatility', 'trend', 'correlation', 'volume'], lookbackPeriod = 60, confidenceThreshold = 75 } = body;
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(regime, {
            source: 'fresh',
            ttl: 2400, // 40 minutes
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to predict market regime', 'REGIME_PREDICTION_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleVolatilityForecast(request, env, headers, requestId) {
    ...
    try {
        ...
        const body = await request.json();
        const { symbol = 'SPY', timeframe = '1w', method = 'garch', confidenceInterval = 0.95 } = body;
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(volatility, {
            source: 'fresh',
            ttl: 1800, // 30 minutes
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate volatility forecast', 'VOLATILITY_FORECAST_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
...
async function handleSentimentEnhancedPrediction(request, env, headers, requestId) {
    ...
    try {
        ...
        const body = await request.json();
        const { symbols = ['AAPL', 'MSFT', 'GOOGL'], sentimentWeight = 0.3, technicalWeight = 0.4, fundamentalWeight = 0.3, timeframe = '1w' } = body;
        ...
        return new Response(JSON.stringify(ApiResponseFactory.success(sentimentEnhanced, {
            source: 'fresh',
            ttl: 1800, // 30 minutes
            requestId,
            processingTime: timer.finish(),
        ...
        return new Response(JSON.stringify(ApiResponseFactory.error('Failed to generate sentiment-enhanced prediction', 'SENTIMENT_ENHANCED_PREDICTION_ERROR', {
            requestId,
            error: error.message,
            processingTime: timer.finish()
        })), {
