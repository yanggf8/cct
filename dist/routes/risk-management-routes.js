...
export class RiskManagementRoutesHandler {
    ...
    async handleRiskAssessment(request) {
        try {
            ...
            if (requestData.portfolio && requestData.portfolio.portfolioId) {
                ...
                const body = ApiResponseFactory.error('Portfolio data with portfolioId is required', 'INVALID_REQUEST');
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'RISK_ASSESSMENT_FAILED');
    ...
    async handleMarketRiskAssessment(request) {
        try {
            ...
            if (requestData.portfolio) {
                ...
                const body = ApiResponseFactory.error('Portfolio data is required', 'INVALID_REQUEST');
                return new Response(JSON.stringify(body), { status: 400 });
            }
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'MARKET_RISK_ASSESSMENT_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleConcentrationRiskAssessment(request) {
        try {
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'CONCENTRATION_RISK_ASSESSMENT_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleLiquidityRiskAssessment(request) {
        try {
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'LIQUIDITY_RISK_ASSESSMENT_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleStressTest(request) {
        try {
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'STRESS_TEST_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleComplianceAssessment(request) {
        try {
            ...
            const assessment = await this.complianceEngine.performComplianceAssessment(portfolioData, clientData, frameworks);
            const body = ApiResponseFactory.success({
                compliance: {
                    id: assessment.id,
                    assessmentDate: assessment.assessmentDate,
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'COMPLIANCE_ASSESSMENT_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleRegulatoryReport(request) {
        try {
            ...
            if (!portfolioData || !reportType) {
                const body = ApiResponseFactory.error('Portfolio data and reportType are required', 'INVALID_REQUEST');
                return new Response(JSON.stringify(body), { status: 400 });
            }
            const report = await this.complianceEngine.generateRegulatoryReport(portfolioData, reportType, framework, period);
            const body = ApiResponseFactory.success({
                report: {
                    id: report.id,
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'REGULATORY_REPORT_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleRiskLimitsCheck(request) {
        try {
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'RISK_LIMITS_CHECK_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleRiskAnalytics(request) {
        try {
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'RISK_ANALYTICS_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
    /**
    ...
    async handleRiskHealthCheck(request) {
        try {
            ...
            const body = ApiResponseFactory.error((error instanceof Error ? error.message : String(error)), 'HEALTH_CHECK_FAILED');
            return new Response(JSON.stringify(body), { status: 500 });
        }
    }
}
...
export async function handleRiskManagementRequest(request, env, ctx) {
    ...
    // Not found
    const body = ApiResponseFactory.error(`Risk endpoint ${path} not found`, 'ENDPOINT_NOT_FOUND');
    return new Response(JSON.stringify(body), { status: 404 });
}
//# sourceMappingURL=risk-management-routes.js.map