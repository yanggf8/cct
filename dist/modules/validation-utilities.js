...
export const RequestValidation = {
    ...
    validateContentType(request, expectedTypes = ['application/json']) {
        ...
        const isValid = expectedTypes.some(type => contentType.toLowerCase().includes(type.toLowerCase()));
        if (!isValid) {
...
export class ValidationResult {
     ...
     */
    getErrorMessages() {
        return this.errors.map(error => typeof error === 'object' ? error.message || JSON.stringify(error) : error);
    }
}
/**
...
//# sourceMappingURL=validation-utilities.js.map