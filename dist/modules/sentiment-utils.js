 ...
 */
export function confidenceToReliability(confidence) {
    if (confidence >= 0.8)
        return 'high';
    if (confidence >= 0.6)
        return 'medium';
 ...
 */
export function generateSentimentSignal(sentiment, confidence) {
 ...
 */
export function formatSentimentForAPI(parsed, symbol, timestamp) {
...
//# sourceMappingURL=sentiment-utils.js.map