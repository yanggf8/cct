...
export class CacheMetrics {
    constructor() {
        ...
        this.WARNING_INTERVAL_MS = 3600000; // 1 hour
     ...
     */
    checkLayerThreshold(layer, metrics) {
     ...
     */
    checkNamespaceThreshold(nsMetrics) {
     ...
     */
    calculateLayerMetrics(hits, misses) {
    ...
    getStats() {
        ...
        for (const [namespace, metrics] of this.namespaceMetrics.entries()) {
            ...
            const nsOverall = this.calculateLayerMetrics(metrics.l1Hits + metrics.l2Hits, metrics.l1Misses + metrics.l2Misses);
     ...
     */
    assessHealth(l1, l2, overall, namespaces) {
        const issues = [];
...
//# sourceMappingURL=DO_CACHE_METRICS.js.map