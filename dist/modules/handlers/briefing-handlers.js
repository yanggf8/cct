 ...
 */
export const handlePreMarketBriefing = createHandler('pre-market-briefing', async (request, env, ctx) => {
 ...
 * Generate comprehensive pre-market HTML
 */
function generatePreMarketHTML(briefingData, requestId, currentDate) {
 ...
 */
function generatePartialBriefing(dateStr, completionRate) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
 ...
 * Generate error HTML
 */
function generateErrorHTML(error, requestId) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
 ...
 */
function generateMarketOverview(marketData) {
    if (!marketData) {
...
//# sourceMappingURL=briefing-handlers.js.map