...
export const handleManualAnalysis = createAPIHandler('enhanced-analysis', async (request, env, ctx) => {
    ...
    try {
        ...
        BusinessMetrics.analysisCompleted('manual_enhanced', analysis.symbols_analyzed?.length || 0, analysis.execution_metrics?.total_time_ms || 0);
        const options = {
            requestId: ctx.requestId,
            symbolsAnalyzed: analysis.symbols_analyzed?.length || 0,
            processingTime: analysis.execution_metrics?.total_time_ms,
            confidence: analysis.overall_confidence || 0.75 // Default confidence if not specified
        };
        ...
        try {
            ...
            BusinessMetrics.analysisCompleted('manual_fallback', basicAnalysis.symbols_analyzed?.length || 0, basicAnalysis.execution_metrics?.total_time_ms || 0);
            const options = {
                requestId: ctx.requestId,
...
export async function handleSentimentTest(request, env) {
    ...
    try {
        ...
        const validation = await validateSentimentEnhancement(env);
...
export async function handleKVVerificationTest(request, env) {
    ...
    try {
        ...
        try {
            ...
            results.test_operationsput_with_verification = {
                success,
        ...
        try {
            ...
            results.test_operationsget_with_retry = {
                success: true,
        ...
        try {
            ...
            results.test_operationsjob_status_system = {
                success: true,
        ...
        try {
            ...
            results.test_operationsdependency_validation = {
                success: true,
        ...
        try {
            ...
            results.test_operationscleanup = {
                success: true,
                key: testKey
            };
