 ...
 */
export async function sendTeamsMessage(message, env) {
 ...
 */
export async function sendTeamsAnalysisMessage(title, analysisText, reportUrl, analysisType, env) {
    ...
    const message = {
        title: title,
        text: analysisText,
        themeColor: themeColors[analysisType] || '0084FF',
        sections: [
            {
                activityTitle: title,
                activitySubtitle: new Date().toLocaleString('en-US', {
 ...
 */
export async function sendTeamsErrorAlert(errorTitle, errorDetails, env) {
 ...
 */
export async function sendTeamsSuccessMessage(title, successText, reportUrl, env) {
 ...
 */
export async function sendTeamsMorningBriefing(reportText, reportUrl, env) {
    return sendTeamsAnalysisMessage("🌅 Pre-Market Briefing", "Market analysis ready for trading day opening. High-confidence signals identified.", reportUrl, 'morning', env);
}
/**
 * Send midday intraday check to Teams
 */
export async function sendTeamsMiddayUpdate(reportText, reportUrl, env) {
    return sendTeamsAnalysisMessage("📈 Intraday Performance Check", "Real-time tracking of morning predictions and market performance.", reportUrl, 'midday', env);
}
/**
 * Send end-of-day summary to Teams
 */
export async function sendTeamsDailySummary(reportText, reportUrl, env) {
    return sendTeamsAnalysisMessage("📊 End-of-Day Summary", "Market close analysis with tomorrow's trading outlook and key insights.", reportUrl, 'daily', env);
}
/**
 * Send weekly review to Teams
 */
export async function sendTeamsWeeklyReview(reportText, reportUrl, env) {
    return sendTeamsAnalysisMessage("📈 Weekly Review & Analysis", "Comprehensive weekly performance analysis with trading pattern insights.", reportUrl, 'weekly', env);
}
export default {
    sendTeamsMessage,
