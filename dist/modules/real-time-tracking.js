...
class RealTimeSignalTracker {
     ...
     */
    getDivergentSignals() {
        return Array.from(this.activeSignals.values()).filter(signal => signal.tracking?.intradayPerformance?.divergenceLevel === 'high');
    }
    /**
...
//# sourceMappingURL=real-time-tracking.js.map