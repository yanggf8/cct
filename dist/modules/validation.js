 ...
 */
export function validateNumberRange(value, field, min, max) {
 ...
 */
export function validatePercentage(value, field) {
    return validateNumberRange(value, field, 0, 100);
}
/**
 * Confidence Threshold Validation
 */
export function validateConfidenceThreshold(value, field) {
 ...
 */
export function validateOptionalField(value, validator, field) {
 ...
 * API Key Validation
 */
export function validateApiKey(apiKey, validKeys = ['yanggf', 'demo', 'test']) {
 ...
 */
export function validateArray(value, itemValidator, field, options = {}) {
 ...
 */
export function safeValidate(value, validator, context = 'validation') {
    try {
