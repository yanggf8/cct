...
export class EnhancedCacheMetricsManager {
    constructor(customThresholds) {
        ...
        this.maxRecentOperations = 10000; // Keep last 10K ops for percentiles
        // Prometheus histogram buckets (in milliseconds)
        this.latencyBuckets = [0.1, 0.5, 1, 2, 5, 10, 25, 50, 100, 250, 500, 1000, 2500, 5000, 10000];
        this.thresholds = {
            l1HitRate: 0.7, // 70%
            l2HitRate: 0.5, // 50%
 ...
 */
export function createEnhancedCacheMetricsManager(customThresholds) {
    return new EnhancedCacheMetricsManager(customThresholds);
}
export default EnhancedCacheMetricsManager;
//# sourceMappingURL=enhanced-cache-metrics.js.map