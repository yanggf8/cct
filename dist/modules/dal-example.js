 ...
 */
export async function advancedDALExample(env) {
    const dal = createDAL(env);
    const operations = [];
    ...
    try {
        ...
        const filteredKeys = listResult.keys ? listResult.keys.filter(key => key.includes('2025') && !key.includes('manual')) : [];
        operations.push({
...
//# sourceMappingURL=dal-example.js.map