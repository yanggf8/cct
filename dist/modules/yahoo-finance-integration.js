...
export async function getMarketData(symbol) {
    try {
        ...
        configureYahooRateLimiter(cfg.RATE_LIMIT_REQUESTS_PER_MINUTE || 100, cfg.RATE_LIMIT_WINDOW_MS || 60000);
 ...
 */
export async function getBatchMarketData(symbols) {
    const results = {};
 ...
 */
export async function getMarketStructureIndicators() {
    const symbols = [
        '^VIX', // VIX
        'SPY', // S&P 500 ETF
 ...
 */
export function isMarketOpen(marketData) {
    if (!marketData)
        return false;
 ...
 */
export function getMarketStatus(marketData) {
    if (!marketData)
        return 'Unknown';
...
//# sourceMappingURL=yahoo-finance-integration.js.map