...
import { healthCheck as yahooHealthCheck } from './yahoo-finance-integration.js';
...
export class APIHealthMonitor {
    ...
    async checkCacheHealth() {
        ...
        try {
            ...
            await cacheManager.set(namespace, testKey, testValue, { l1: 60, l2: 60 });
            // Read test
            const retrieved = await cacheManager.get(namespace, testKey);
            // Cleanup
     ...
     */
    generateHealthReport(apiChecks) {
     ...
     */
    generateRecommendations(apiChecks) {
 ...
 */
export function initializeAPIHealthMonitor(env, options) {
    return new APIHealthMonitor(env, options);
}
export default APIHealthMonitor;
//# sourceMappingURL=api-health-monitor.js.map