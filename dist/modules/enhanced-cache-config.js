 ...
 */
export const ENHANCED_CACHE_CONFIGS = {
    development: {
...
export function getCurrentEnvironment() {
    const env = typeof globalThis !== 'undefined' && globalThis.ENV
        ? globalThis.ENV
        : 'development';
 ...
 */
export function getCacheNamespaces() {
    const environment = getCurrentEnvironment();
    const configs = ENHANCED_CACHE_CONFIGS[environment];
 ...
 */
export function createEnhancedCacheConfigManager(environment) {
...
//# sourceMappingURL=enhanced-cache-config.js.map