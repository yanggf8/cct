...
export class AdminRateLimiter {
    ...
    checkTokenBucket(key) {
        ...
        const tokensToAdd = Math.floor((timeSinceRefill / this.config.windowMs) * this.config.maxRequests);
 ...
 */
export function createRateLimitMiddleware(rateLimiter, algorithm = 'token-bucket') {
    return (request) => {
...
//# sourceMappingURL=admin-rate-limiter.js.map