...
export async function generateIntradayPerformance(analysisData, morningPredictions, env) {
    ...
    try {
        ...
        const performanceResults = comparePerformanceVsPredictions(morningPredictions, currentPrices, analysisData);
...
function comparePerformanceVsPredictions(morningPredictions, currentPrices, analysisData) {
    ...
    Object.keys(signals).forEach(symbol => {
        ...
        if (currentPerformance) {
            const isCorrect = (predictedDirection === 'up' && currentPerformance.change > 0) ||
...
//# sourceMappingURL=intraday-analysis.js.map