...
function analyzeWeeklyPatterns(weeklyData) {
    ...
    if (avgAccuracy > 75)
        patterns.overallPerformance = 'excellent';
    else if (avgAccuracy > 65)
        patterns.overallPerformance = 'strong';
    else if (avgAccuracy > 55)
        patterns.overallPerformance = 'moderate';
    else
        patterns.overallPerformance = 'needs-improvement';
    return patterns;
}
/**
...
function calculateBiasTrend(biases) {
    ...
    if (bullishCount > bearishCount)
        return 'increasingly-bullish';
    if (bearishCount > bullishCount)
        return 'increasingly-bearish';
    return 'neutral';
}
/**
...
//# sourceMappingURL=weekly-review-analysis.js.map