...
export declare function isKVNamespace(value: any): value is KVNamespace;
export declare function isR2Bucket(value: any): value is R2Bucket;
export declare function isD1Database(value: any): value is D1Database;
export declare function isDurableObjectNamespace(value: any): value is DurableObjectNamespace;
export declare function isAi(value: any): value is Ai;
